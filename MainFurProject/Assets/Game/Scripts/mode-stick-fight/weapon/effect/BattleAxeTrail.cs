...
public class BattleAxeTrail : MonoBehaviour
{
    ...
    public void Init(ContactFilter2D enemyContactFilter, DamageDealerInfo damageDealerInfor, int direction)
    {
    ...
    void CreateEffect()
    {
        ...
        for(int i = 0; i < m_numberOfEff; i++)
        {
            ...
            rightEffect.GetComponent<BattleAxeTrailChild>().Init(m_damageDealerInfor.damage);
        }
    }
